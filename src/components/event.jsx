  ...
  return (
    <div className="eventPage">
      <div className="eventHero">
        <h1>{event.title}</h1>
        <div className="hostedBy">
          <img src={event.speaker.image} alt="Host Logo" />
          <div>
            <h3>Hosted BY:</h3>
            <h3>{event.speaker.name} and others</h3>
          </div>
        </div>
      </div>
      <div className="eventMain">
        ...
        <div className="eventRight">
          <div className="EventHead">
            <img src={event.speaker.image} alt="Event Host Image" />
            <div className="eventDescription">
        ...
        <div className="attendeesList">
          {event.attendees.map((attendee, index) => (
            <img
              ...
              onClick={() => handleImageClick(attendee)}
            />
          ))}
        </div>
      </div>
        ...
        <div className="sponsorsList">
          {event.sponsors.map((sponsor, index) => (
            <img
              ...
              src={sponsor}
              alt={`Sponsor ${index + 1}`}
              onClick={() => handleImageClick(sponsor)}
            />
          ))}
        </div>
      </div>
        ...
        <div className="interestedList">
          {event.interests.map((interest, index) => (
            <img
              key={index}
              src={interest}
              alt={`Interested Event ${index + 1}`}
              onClick={() => handleImageClick(interest)}
            />
          ))}
          {/* {isPopupOpen && (
            <div className="popup-overlay" onClick={closePopup}>
